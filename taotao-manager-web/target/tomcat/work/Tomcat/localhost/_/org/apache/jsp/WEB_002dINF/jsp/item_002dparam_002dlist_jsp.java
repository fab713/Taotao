 ...
 * Generated at: 2018-09-20 02:28:25 UTC
...
public final class item_002dparam_002dlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("<table class=\"easyui-datagrid\" id=\"itemParamList\" title=\"规格参数列表\"\r\n");
      ...
      out.write("\t\t\t\thandler : function() {\r\n");
      out.write("\t\t\t\t    \tvar ids = TT.getSelectionsIds(\"#itemParamList\");\r\n");
      ...
      out.write("\t\t\t\t\t\t\turl : \"/item-param-edit\",\r\n");
      out.write("\t\t\t\t\t\t\tonLoad : function(){\r\n");
      out.write("\t\t\t\t\t\t\t\tvar data = $(\"#itemParamList\").datagrid(\"getSelections\")[0];\r\n");
      out.write("\t\t\t\t\t\t\t\t$(\"#contentEditForm\").form(\"load\",data);\r\n");
      out.write("\t\t\t\t\t\t\t\t//获取itemParam\r\n");
      out.write("\t\t\t\t\t/* \t\t\talert(data.id);\r\n");
      out.write("\t\t\t\t\t\t\t\talert(data.itemCatId);\t */\r\n");
      out.write("\t\t\t\t\t\t\t\tTAOTAO.init({\r\n");
      out.write("\t\t\t        \t\t\t\t\"cid\" : data.itemCatId,\r\n");
      out.write("\t\t\t        \t\t\t\tfun:function(node){\r\n");
      out.write("\t\t\t        \t\t\t\t\tTAOTAO.changeItemParam(node, \"contentEditForm\");\r\n");
      out.write("\t\t\t        \t\t\t\t}\r\n");
      out.write("\t\t\t        \t\t\t});\r\n");
      out.write("\t\t \t\t/* \t\t\t $.post(\"/item/param/getItemParam\",{\"id\":data.id}, function(rt){\r\n");
      out.write("\t\t \t\t\t\t\t\t alert(888888888888);\r\n");
      out.write("\t\t\t\t\t\t\t\t\tconsole.log(\"进入ajax\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\tif(rt.status == 200){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tcontentEditEditor.html(rt.data);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t});  */\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
